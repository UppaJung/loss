...
export const generateFreeTextMacros = (outPath: string, responses: AugmentedSurveyResponses) => {
	const toGenerate = [
		...
		[SurveyKeys["locked-device-rec_7_TEXT"], "lockedDeviceRec"],
		...
		[SurveyKeys["hacked-acct-rec_7_TEXT"], "HackedAcctRec"],
		...
		[SurveyKeys["locked-acct-duration_7_TEXT"], "lockedAcctDuration"],
		...
		[SurveyKeys["hacked-soc-duration_7_TEXT"], "HackedSocDuration"],
		...
		[SurveyKeys["locked-soc-duration_7_TEXT"], "lockedSocDuration"],
		...
		[SurveyKeys["locked-pwds-duration_7_TEXT"], "lockedPwdsDuration"],
