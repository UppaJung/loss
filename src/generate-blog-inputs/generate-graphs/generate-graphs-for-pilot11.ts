...
import * as ScenarioMatching from "../../../generated-by-analysis/Pilot11/graph-inputs/scenario-matching-question-data.ts";
import * as DeviceBarChart from "../../../generated-by-analysis/Pilot11/graph-inputs/device-bar-chart-data.ts";
import * as ScenarioRecency from "../../../generated-by-analysis/Pilot11/graph-inputs/scenario-recency-data.ts";
import * as RecoveryDuration from "../../../generated-by-analysis/Pilot11/graph-inputs/recovery-duration-data.ts";
import * as ScenarioLikert from "../../../generated-by-analysis/Pilot11/graph-inputs/likert-data.ts";
import * as HarmScenarioLossDuration from "../../../generated-by-analysis/Pilot11/graph-inputs/harm-quantity-with-likert-severity-data.ts";
import * as HarmScenarioLikert from "../../../generated-by-analysis/Pilot11/graph-inputs/harm-focused-likert-data.ts";
import * as Age from "../../../generated-by-analysis/Pilot11/graph-inputs/age-data.ts";
import * as Demographics from "../../../generated-by-analysis/Pilot11/graph-inputs/demographics-data.ts";
import { data as AccountTypeData } from "../../../generated-by-analysis/Pilot11/graph-inputs/account-type-data.ts";
...
import { BarGraphs } from "../../../generated-by-analysis/Pilot11/graph-inputs/severity-grouped-bar-charts-data.ts";
...
export const generateGraphsPilot11 = (cohort: string = "Pilot11") => {
	...
	Object.entries(BarGraphs).forEach(([key, {labels, data, xTitle}]) => {
		...
		writeSvg(`${key}-bar-chart`, barChartWithSubBarsSvg({
			...
			data, xTitle,
			subBarColors: ["rgb(192, 64, 64)", "orange", "rgb(128, 128, 255)"]
