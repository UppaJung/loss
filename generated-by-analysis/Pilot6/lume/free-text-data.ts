...
export const HackedDeviceType = "2 participants provided free entry responses: 'iPod touch' and 'headset'.";
...
export const HackedTabletType = "1 participant provided a free entry response: 'Fire Tablet'.";
...
export const lockedDeviceType = "1 participant provided a free entry response: 'Apple Music device'.";
...
export const lockedDeviceHow = "1 participant provided a free entry response: 'My kids put in the wrong password too many times.'.";
...
export const lockedAcctType = "1 participant provided a free entry response: 'Bucket Photo'.";
export const lockedAcctHowTotal = "3";
export const lockedAcctHow = "3 participants provided free entry responses: 'It was hacked.', 'gmail account through my college and the system was hacked', and 'lost access to recovery email'.";
...
export const HackedSocType = "1 participant provided a free entry response: 'GroupMe'.";
...
export const HackedSocDuration = "1 participant provided a free entry response: 'Periodically, new attempts would be made to compromise one of two accounts I had. It was always the one without two factor authentication enabled. Eventually, I deleted both accounts, but not due to the frustration that the intrusions caused'.";
...
export const lockedSocHow = "3 participants provided free entry responses: 'Hacked.', 'hacker changed phone number and password', and 'Instagram flagged my account for suspicious behavior'.";
...
export const HackedBankType = "1 participant provided a free entry response: 'Tax refund'.";
...
export const lockedPwdsStored = "1 participant provided a free entry response: 'firefox'.";
